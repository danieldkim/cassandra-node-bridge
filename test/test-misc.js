...
function test_remove_row(test_done) {
  var column_path = column_parent = { 
    column_family: "TestSuperColumnFamily_UTF8_UTF8"
  }
  
  _test_remove(test_done, column_path, column_parent)
}

function test_remove_super_column(test_done) {
  var column_path = column_parent = {
    column_family: "TestSuperColumnFamily_UTF8_UTF8", 
...
function test_remove_column(test_done) {
  var column_path = {
    column_family: "TestSuperColumnFamily_UTF8_UTF8", 
    super_column: columns1[0].name,
...
function _test_remove(test_done, column_path, column_parent) {
  ...
  request.addListener("success", function(result) {
    clean_up_on_exception_for(look_for_it)()
  })
  ...
  function look_for_it() {
    ...
    request.addListener("success", clean_up_after(function(result) {
...
function test_get_super_column_count(test_done) {
...
function test_get_subcolumn_count(test_done) {
  var clean_up_after = test_helpers.clean_up_wrapper_factory(clean_up, test_done).clean_up_after  
...
function test_multiget_slice(test_done) {
  var clean_up_after = test_helpers.clean_up_wrapper_factory(clean_up, test_done).clean_up_after  
